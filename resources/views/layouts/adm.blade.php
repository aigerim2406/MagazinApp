...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Pandora ME</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
               aria-expanded="true" aria-controls="collapseUtilities">
                ...
                <span>{{__('messages.Content Management')}}</span>
            </a>
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                @if(Auth::user()->role->name != 'user')
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('adm.categories.show')}}">{{__('messages.Category:')}}</a>
                </div>
                @endif
            </div>
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('adm.users.comments')}}">{{__('messages.Reviews:')}}</a>
                </div>
                @endif
            </div>
        </li>
        ...
        <li class="nav-item">
            @if(Auth::user()->role->name == 'admin')
                <a class="nav-link" href="{{route('adm.shops.cart')}}">
